...
@section('content')
    <div class="min-vh-100 d-flex align-items-center position-relative overflow-hidden" style="background: linear-gradient(135deg, #f8fafc 0%, #e0e7ff 100%);">
        ...
        <div class="position-absolute top-0 start-0 w-100 h-100" style="z-index: 1; opacity: 0.85;">
            <svg width="100%" height="100%" viewBox="0 0 1440 320" preserveAspectRatio="none" style="position: absolute; bottom: 0;">
                ...
                <path fill="#1e40af" fill-opacity="0.65" d="M0,256L48,240C96,224,192,192,288,186.7C384,181,480,203,576,213.3C672,224,768,224,864,202.7C960,181,1056,139,1152,122.7C1248,107,1344,117,1392,122.7L1440,128L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
            </svg>
        </div>
                            ...
                            <form method="POST" action="{{ route('login.submit') }}" novalidate>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="position-relative">
                                        <input id="password" type="password" class="form-control form-control-lg @error('password') is-invalid @enderror" name="password" required style="padding-right: 50px;">
                                        <button type="button" class="btn position-absolute end-0 top-50 translate-middle-y border-0 bg-transparent text-muted toggle-password" style="z-index: 10; margin-right: 10px;">
                                            <i class="bi bi-eye"></i>
                                        </button>
                                    </div>
                                    @error('password')
