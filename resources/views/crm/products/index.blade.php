...
<div class="container-fluid p-0">
    <div class="card border-0 shadow-sm overflow-hidden">
        <div class="card-header border-bottom-0 py-3 px-4">
            ...
            @include('crm.partials.module-filter-config', ['module' => 'products', 'searchId' => 'productsSearch', 'placeholder' => 'Search products...'])
        </div>
...
@push('scripts')
    ...
    <script src="{{ url((env('PUBLIC_PATH') ? rtrim(env('PUBLIC_PATH'), '/') . '/' : '') . 'js/product.js') }}?v={{ filemtime(public_path('js/product.js')) }}"></script>
@endpush
